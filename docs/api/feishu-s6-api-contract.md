...
- 设置页 UI（独立壳窗口）——入口：壳左侧导航为主 + 托盘补充（双入口，共识 v1.5 主窗口形态；独立窗口形态保留）：
...
- 托盘完整：dsh 运行状态 / 打开主窗口 / Hull 设置 / 检查 dsh 更新 / 升级进行中（禁用）/ 退出（补充入口，以壳左侧导航为主，共识 v1.5）
...
| 2 | NEW | SettingsStore.set(patch) | 增量更新+持久化 | 设置页 | 是 |
