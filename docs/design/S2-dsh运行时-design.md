...
> 版本：0.2 · 2026-08-17
> 事实源：契约 `docs/api/feishu-s2-api-contract.md` v0.2（已冻结）；共识 `docs/spec/共识-Hull桌面壳-M1.md` v1.4（CON-R002/007/008/010/014/016、Q-004/Q-011）；PRD `docs/prd/2026-08-14-m1-prd.md`；原型 `docs/prototype/2026-08-14-m1-prototype/index.html`（引导态/安装进度视图）
